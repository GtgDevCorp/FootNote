...
main()
{
    ...
    lngErrorcode = AddRequest(lngHandle, LJ_ioPUT_CONFIG, LJ_chAIN_RESOLUTION, 0, 0, 0);
    ErrorHandler(lngErrorcode, __LINE__, 0);
    ...
    ErrorHandler(lngErrorcode, __LINE__, 0);
    lngErrorcode = AddRequest(lngHandle, LJ_ioADD_STREAM_CHANNEL_DIFF, 1, 0, 15, 0); // second method for single ended reading - AIN1
    ErrorHandler(lngErrorcode, __LINE__, 0);
